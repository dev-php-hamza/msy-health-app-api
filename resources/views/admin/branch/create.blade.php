				...
				<div class="x_content">
					<form class="form-horizontal form-label-left" method="post" action="{{ route('branches.store') }}">
						...
						<div class="form-group row">
                          ...
                          class="required">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-6">
								<input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter branch name" value="{{ old('name') }}" required>
								@error('name')
						...
						<div class="form-group row">
                          ...
                          class="required">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-6">
								<select class="form-control" name="country_id" required onchange="getCompAndLoc(this)">
